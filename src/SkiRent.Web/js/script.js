        ...
        .then((data) => {
          ...
          data.forEach((item) => {
            ...
            if (staticImages[item.name]) {
              ...
              imageUrl = "../assets/pictures/SkiRent_sieloLogo.png"; // alapértelmezett kép
            }
